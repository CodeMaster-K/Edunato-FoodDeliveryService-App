...
import userImg from '/images/edunato.png';
...
const User = () => {
    ...
    let data3 = [
        {userId: 123, imgSrc:userImg, userName: "NITHIN SHIYAM", reviews: 96, followers: "96k"},
        {userId: 123, imgSrc:userImg, userName: "EDUNET Foundation", reviews: 200, followers: "600k"},
        {userId: 123, imgSrc:userImg, userName: "EY GDS", reviews: 460, followers: "230k"},
        {userId: 123, imgSrc:userImg, userName: "Edunato", reviews: 234, followers: "2M"}
    ]

    let data4 = {
      profilePic: userImg,
      userName: "NITHIN SHIYAM",
      reviews: 1,
      photos: 1,
      followers: 200
    }
    ...
    <div className={css.box}>
      ...
      <div className={css.mainbody}>
        <div className={css.leftBox}>
          ...
          <ProfileWidget name='Edunato PROFILE WIDGET' tag="Showcase your Edunato profile on your blog." data={data4} />
        </div>
