...
let ExploreOptionsNearMe = () => {
    let chain = ['Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag', 'Che', 'cheenai', 'vizag']
