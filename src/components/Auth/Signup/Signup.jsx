        ...
        <div className={signupCss.modal}>
            ...
            <div className={signupCss.lgBox}>
                ...
                <span className={signupCss.termsTxt}>
                    ...
                    <span>
                        I agree to Edunato's <a href="" className={signupCss.termaAnchor}>Terms of Service, Privacy Policy</a> and <a href="" className={signupCss.termaAnchor}>Content Policies</a>
                    </span>
                </span>
            ...
            <div className={signupCss.newToEdunato}>Already have an account? <div className={signupCss.createAcc} onClick={() => setAuth({ closed: false, login: true, signup: false })} >Log in</div></div>
        </div>
    </div>
