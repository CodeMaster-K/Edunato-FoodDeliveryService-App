            ...
            <div className={css.txtBox}>
              <div className={css.leftBox}>
                ...
                <div className={css.profileDetails}>
                  <div className={css.name}>Nithin Shiyam K</div>
                  <span className={css.location}> <img src={location} className={css.locationIcon} /> Edunet</span>
                </div>
              </div>
